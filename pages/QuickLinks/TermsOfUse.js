...
const TermsOfUse = () => {
  return (
    <AnimatePresence>
      ...
      >
        <motion.p className="text-center font-semibold text2xl md:text-3xl py-10">
          Legal Terms of Use
        </motion.p>
        <motion.div>
          <motion.p className="my-7">
            MingleWise is a flagship app of AppSynergies Ltd who control all of
            its Intellectual Property Rights. These terms and conditions apply
            between you, the User of this Website (including any sub-domains,
            unless expressly excluded by their own terms and conditions), and
            AppSynergies Ltd, the owner and operator of this Website. Please
            read these terms and conditions carefully, as they affect your legal
            rights. Your agreement to comply with and be bound by these terms
          ...
          <motion.p className="mb-10">
            ...
            AppSynergies Ltd and acting in the course of their employment or
            (ii) engaged as a consultant or otherwise providing services to
            AppSynergies Ltd and accessing the Website in connection with the
            provision of such services. You must be at least 18 years of age to
            use this website and mobile application. By using the Website and
            agreeing to these terms and conditions, you represent and warrant
            that you are at least 18 years of age.
          </motion.p>
        </motion.div>
        <motion.ul className="font-semibold mb-14">
          <motion.li>Acceptance of Agreement</motion.li>
          <motion.li>Changes To Agreement</motion.li>
          <motion.li>Electronic Records</motion.li>
          <motion.li>Eligibility</motion.li>
          <motion.li>Use of Service</motion.li>
          <motion.li>Paid Service</motion.li>
          <motion.li>User Content</motion.li>
          <motion.li>Prohibited Use</motion.li>
          <motion.li>Limitation of Liability</motion.li>
          <motion.li>General</motion.li>
        </motion.ul>
        <motion.div>
          ...
          <motion.p>
            These Terms of Use (the “Agreement”) constitute a legal agreement
            that governs the relationship with users and others who interact
            with AppSynergies Ltd, subsidiaries and affiliates (“MingleWise,”
            “AppSynergies” “we,” or “us”) in connection with the use of
            MingleWise.com and/or other websites (the “Sites”) and our Service
            (as defined below). MingleWise may make services, products and
            features available through our Sites, applications including Mobile
            Software and applications available on social networking sites and
            other platforms, and other downloadable products (the Sites, the
            applications, the downloadable products, and all products, services,
            and features provided by MingleWise in connection, including without
            ...
            MingleWise may offer additional services or products or modify or
            revise any part of the Service at our discretion, and this Agreement
            will apply to all additional services or products and all modified
            or revised Service unless otherwise indicated. MingleWise also
            reserves the right to cease offering any part of the Service. You
            agree that MingleWise shall not be liable to you or any third party
            for any modification, revision, suspension or discontinuance of any
            part of the Service.
          </motion.p>
        </motion.div>
        <motion.div>
          ...
          <motion.p>
            ...
            MingleWise shall provide notice of any such modification by posting
            the revised Agreement to the Sites.you or any third party for any
        ...
        <motion.div>
          ...
          <motion.p>
            ...
            MingleWise providing important information electronically if you
            wish to use the Service. You consent to being provided with this
            Agreement, notices, disclosures, information, policies and other
            materials in electronic form (collectively, “Electronic Records”),
            rather than in paper form. Your consent to receive Electronic
            Records applies to all notices, disclosures, documents, records or
            other materials of any kind that MingleWise may be required to
            provide to you.
          </motion.p>
        </motion.div>
        <motion.div>
        ...
        <motion.div>
          ...
          <motion.p>
            You agree that you will only use the Service, including the posting
            of any content through the Service, in a manner consistent with this
            Agreement and any and all applicable local, state, national and
        ...
        <motion.div>
          ...
          <motion.p>
            The Paid Service may also be purchased through your accounts with
            certain third parties, such as your Apple iTunes account, your
            Google Play account or your Amazon account (a “Third Party
            Account”). If you purchase any Paid Service through a Third Party
            Account, billing for these Paid Service will appear through your
            Third Party Account. You should review the Third Party Account’s
            terms and conditions, which we do not control.
          </motion.p>
        </motion.div>
        <motion.div>
          <motion.p className="font-semibold mb-2 mt-8">
          ...
          <motion.p>
            ...
            certain information and post a photo of yourself to use the Service.
          </motion.p>
        </motion.div>
        <motion.div>
          <motion.p className="font-semibold mb-2 mt-8">
          ...
          <motion.ul className="list-disc ml-5">
            ...
            <motion.li>
              ...
              any statutory rights. You can also unsubscribe from the mailing
              list at anytime. The link to unsubscribe is included at the bottom
          ...
          <motion.ul className="list-disc ml-5">
            <motion.li>
              ...
              stated, these sites are not under the control of AppSynergies Ltd
        ...
        <motion.div>
          ...
          <motion.ul className="list-disc ml-5">
            ...
            <motion.li>
              To the maximum extent permitted by law, AppSynergies Ltd accepts
              no liability for any of the following: (a) Any business losses,
              such as loss of profits, income, revenue, anticipated savings,
              business, contracts, goodwill or commercial opportunities; (b)
              Loss or corruption of any data, database or software; (c) Any
              special, indirect or consequential loss or damage.
            </motion.li>
          </motion.ul>
        </motion.div>
        <motion.div>
          <motion.p className="font-semibold mb-2 mt-8">10. General</motion.p>
          <motion.ul className="list-disc ml-5">
            <motion.li>
            ...
            <motion.li>
              ...
              contain the whole agreement between the parties relating to its
              subject matter and supersede all prior discussions, arrangements
            ...
            <motion.li>
              AppSynergies Ltd is a company incorporated in England and Wales
              with registered number 12084991 whose registered address is
              AppSynergies Ltd, 186 Malvern Avenue, Harrow, London, England, HA2
              9HD and it operates the website. You can contact AppSynergies Ltd
              by emailing info@appsynergies.com.
            </motion.li>
          </motion.ul>
        </motion.div>
      </motion.div>
