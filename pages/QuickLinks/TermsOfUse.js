        ...
        >
          ...
          <motion.div>
            <motion.p className="my-7">
              ...
              conditions), and AppSynergies Ltd, the owner and operator of this
              Website. Please read these terms and conditions carefully, as they
              affect your legal rights. Your agreement to comply with and be
              bound by these terms and conditions is deemed to occur upon your
              first use of the Website. If you do not agree to be bound by these
              terms and conditions, you should stop using the Website
              immediately.
            </motion.p>
            <motion.p className="mb-10">
              ...
              provision of such services. You must be at least 18 years of age
              to use this website and mobile application. By using the Website
              and agreeing to these terms and conditions, you represent and
          ...
          <motion.div>
            ...
            <motion.p>
              ...
              features available through our Sites, applications including
              Mobile Software and applications available on social networking
              sites and other platforms, and other downloadable products (the
              Sites, the applications, the downloadable products, and all
              products, services, and features provided by MingleWise in
              connection, including without limitation interfaces of the Service
              whether in whole or in part (therewith shall be referred to
              collectively as, the “Service”). MingleWise may offer additional
              services or products or modify or revise any part of the Service
              at our discretion, and this Agreement will apply to all additional
              services or products and all modified or revised Service unless
              otherwise indicated. MingleWise also reserves the right to cease
              offering any part of the Service. You agree that MingleWise shall
          ...
          <motion.div>
            ...
            <motion.p>
              ...
              posting the revised Agreement to the Sites.you or any third party
              for any modification, revision, suspension or discontinuance of
          ...
          <motion.div>
            ...
            <motion.p>
              ...
              Electronic Records applies to all notices, disclosures, documents,
              records or other materials of any kind that MingleWise may be
          ...
          <motion.div>
            ...
            <motion.p>
              ...
              posting of any content through the Service, in a manner consistent
              with this Agreement and any and all applicable local, state,
          ...
          <motion.div>
            ...
            <motion.ul className="list-disc ml-5">
              ...
              <motion.li>
                ...
                effect for any reasonable purposes or if you breach these terms
                and conditions. ​
              </motion.li>
              <motion.li>
                ...
                list at anytime. The link to unsubscribe is included at the
                bottom of all email correspondence.
              </motion.li>
            </motion.ul>
            ...
            <motion.ul className="list-disc ml-5">
              <motion.li>
                ...
                stated, these sites are not under the control of AppSynergies
              ...
              <motion.li>
                ...
                not imply any endorsement of the sites themselves or of those in
                control of them.
              </motion.li>
            </motion.ul>
          </motion.div>
          ...
          <motion.div>
            ...
            <motion.ul className="list-disc ml-5">
              ...
              <motion.li>
                ...
                or agreements that might have taken place in relation to the
              ...
              <motion.li>
                ...
                AppSynergies Ltd, 186 Malvern Avenue, Harrow, London, England,
                HA2 9HD and it operates the website. You can contact
