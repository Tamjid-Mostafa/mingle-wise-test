      ...
      >
        <div className="bg-[#FCFCFC]">
          <div className="w-[95%] md:w-[90%] lg:w-[70%] mx-auto flex flex-col justify-center items-center min-h-[50vh] 2xl:min-h-[45vh] text-center pt-5 sm:pt-32 2xl:pt-20">
            ...
            >
              ...
              & helps its users find, meet & develop meaningful connections
              using AI
            </motion.p>
            <motion.p
              ...
              className="mt-5 text-justify sm:text-center md:w-[80%] w-[95%] mx-auto"
            >
        ...
        <div className="w-[95%] md:w-[90%] lg:w-[60%] mx-auto flex flex-col justify-center min-h-[60vh] sm:min-h-[40vh] poppins-text py-10">
          ...
          >
            ...
            App SYNERGIES design and develop web and mobile applications for our
            clients worldwide, focusing on outstanding user experience.
          </motion.p>
          <motion.p
            initial={{ opacity: 0, scale: 1.2, x: "-40%" }}
            whileInView={{ opacity: 1, scale: 1, x: 0 }}
          ...
          >
            You can head over to App Synergies to know more about the company or
          ...
          <div className="xl:w-[70%] mx-auto poppins-text">
            <div className="px-2">
              ...
              >
                ...
                celebrating special moments with people who live in your
              ...
              >
                ...
                launching soon in United States, Europe & India on the Apple App
                Store & Google Play Store. As a platform we will continuously
                keep evolving & empowering people to develop truly meaningful
