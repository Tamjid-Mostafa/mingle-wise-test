            ...
            {SUBSCRIPTION_TIRES.map((data, index) => (
              <tr key={index} className="border-2">
                ...
                <td className=" py-3 px-4 border-2 bg-[#F5F5F5] text-4xl text-[#7E02D8]">
                  {data?.mingleElite && <GoPrimitiveDot className="mx-auto" />}
                </td>
                <td className=" py-3 px-4 border-2 bg-[#ECECEC] text-4xl text-[#4A2E2E]">
                  {data?.mingleCeleb && <GoPrimitiveDot className="mx-auto" />}
                </td>
              </tr>
            ))}
          </table>
        ...
        <div className="sm:hidden">
          <div className="mt-10 w-[90%] bg-white rounded-md mx-auto shadow">
            ...
            <ul className="px-4 py-3 poppins-text">
              <li className="flex items-center gap-1">
                <BsPinAngleFill className="text-purple-600" /> Mingle Date & Pro
                Profiles
              </li>
              <li className="flex items-center gap-1">
          ...
          <div className="mt-10 w-[90%] bg-white rounded-md mx-auto shadow">
            ...
            <ul className="px-4 py-3 poppins-text">
              ...
              <li className="flex items-center gap-1">
                <BsPinAngleFill className="text-purple-600" /> See who likes you
              </li>
              <li className="flex items-center gap-1">
          ...
          <div className="mt-10 w-[90%] bg-white rounded-md mx-auto shadow">
            ...
            <ul className="px-4 py-3 poppins-text">
              ...
              <li className="flex items-center gap-1">
                <BsPinAngleFill className="text-purple-600" /> Advanced Filters
              </li>
              <li className="flex items-center gap-1">
              ...
              <li className="flex items-center gap-1">
                <BsPinAngleFill className="text-purple-600" /> Profile Insights
              </li>
              <li className="flex items-center gap-1">
                <BsPinAngleFill className="text-purple-600" /> Concierge Service
              </li>
            </ul>
          </div>
        </div>
